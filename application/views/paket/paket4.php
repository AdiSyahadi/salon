				...
				<div class="container">
					<div class="row">
						<div class="col-lg-7 text-center mx-auto">
							<h1 class="text-white pt-3 mt-n5">Paket 4</h1>
						...
						<div class="row justify-content-left">
							...
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Body Massage 30'</h5>
						...
						<div class="row justify-content-left mt-5">
							<div class="col-md-6 mt-3">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Scrub Body</h5>
					...
					<div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
						<div class="card card-background card-background-mask-primary tilt" data-tilt>
							...
							<div class="card-body pt-7 text-center">
								...
								<p><strong class="text-white up mb-0">Rp.310.000,-</strong></p>
