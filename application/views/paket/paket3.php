				...
				<div class="container">
					<div class="row">
						<div class="col-lg-7 text-center mx-auto">
							<h1 class="text-white pt-3 mt-n5">Paket 3</h1>
						...
						<div class="row justify-content-left">
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Creambath</h5>
									<p class="pe-5">Cukup denga kli tombol booking maka Anda bisa langsung mendapatkan layanan terbaik kami</p>
									<hr>
								</div>
							</div>
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Menicure</h5>
									<p class="pe-3">Tempat salon yang mudah di jangkau dengan fasilitas yang lengkap</p>
									<hr>
								</div>
							</div>
						</div>
						<div class="row justify-content-left mt-5">
							<div class="col-md-6 mt-3">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Pedicure</h5>
							...
							<div class="col-md-6 mt-3">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">blow dry</h5>
					...
					<div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
						<div class="card card-background card-background-mask-primary tilt" data-tilt>
							...
							<div class="card-body pt-7 text-center">
								...
								<p><strong class="text-white up mb-0">Rp.315,000</strong></p>
