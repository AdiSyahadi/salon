				...
				<div class="container">
					<div class="row">
						<div class="col-lg-7 text-center mx-auto">
							<h1 class="text-white pt-3 mt-n5">Paket 2</h1>
						...
						<div class="row justify-content-left">
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Crembath</h5>
									<p class="pe-5">Creambath kami terkenal karena konsep khususnya yang tidak ditemukan di salon lainnya</p>
									<hr>
								</div>
							</div>
							<div class="col-md-6">
								<div class="info">
									...
									<p class="pe-3">Penata rambut memiliki lebih banyak pengalaman memotong dan menata rambut.</p>
									<hr>
								</div>
							</div>
						</div>
						<div class="row justify-content-left mt-5">
							<div class="col-md-6 mt-3">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Blow</h5>
									<p class="pe-5">kami lebih jauh memberikan sentuhan seni cuci rambut untuk menghasilkan rambut yang sehat memukau</p>
									<hr>
								</div>
							</div>
							<div class="col-md-6 mt-3">
					...
					<div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
						<div class="card card-background card-background-mask-primary tilt" data-tilt>
							...
							<div class="card-body pt-7 text-center">
								...
								<h2 class="text-white up mb-0">Booking <br /> & rasakan sendiri layanan terbaik kami </h2>
								<p><strong class="text-white up mb-0">Rp.325,000</strong></p>
