...
<body>
	<div class="site-wrap">
		...
		<header class="header-2">
			<div class="page-header min-vh-75" style="background-image: url('../../images/hero_bg_2.jpg')">
				<div class="container">
					<div class="row">
						<div class="col-lg-7 text-center mx-auto">
							<h1 class="text-white pt-3 mt-n5">Paket 6</h1>
				...
				<div class="row align-items-center">
						...
						<div class="row justify-content-left">
							...
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Body Massage 60'</h5>
						...
						<div class="row justify-content-left mt-5">
							<div class="col-md-6 mt-3">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Totok Wajah</h5>
					...
					<div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
						<div class="card card-background card-background-mask-primary tilt" data-tilt>
							<div class="full-background" style="background-image: url('../../images/spa-1.jpg')"></div>
							<div class="card-body pt-7 text-center">
								...
								<p><strong class="text-white up mb-0">Rp.365.000,-</strong></p>
