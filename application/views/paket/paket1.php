...
<head>
	<title>Salon Que &mdash; The One Place</title>
	<meta charset="utf-8">
	...
	<link href="<?php echo base_url() . "assets/"; ?>css/nucleo-svg.css" rel="stylesheet" />
	<!-- CSS Files -->
	<link id="pagestyle" href="<?php echo base_url() . "assets/"; ?>css/soft-design-system.css?v=1.0.5" rel="stylesheet" />
...
<body>
	<div class="site-wrap">
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					...
					<div class="col-6 col-xl-2" data-aos="fade-down">
						<h1 class="mb-0"><a href="<?php echo base_url() . "index.php/home/index"; ?>" class="text-black h2 mb-0">Salon Que</a></h1>
					</div>
					<div class="col-10 col-md-8 d-none d-xl-block" data-aos="fade-down">
						<nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
								...
								<li class="has-children active">
									...
									<ul class="dropdown">
										<li class="has-children">
											<a href="#">Hair</a>
											<ul class="dropdown">
												<li><a href="view/menu/hair/haircut.html">Haircut</a></li>
												<li><a href="view/menu/hair/haircut-f.html">Haircut + Fashion Blow</a></li>
												<li><a href="view/menu/hair/blow-f.html">Blow Variasi</a></li>
												<li><a href="view/menu/hair/hairdo.html">Hairdo</a></li>
												<li><a href="view/menu/hair/sanggul-t.html">Sanggul Tradisional</a></li>
											</ul>
										<li class="has-children">
											<a href="#">Treatment</a>
											<ul class="dropdown">
												<li><a href="view/menu/treatment/creambath-t.html">Creambath Tradisional</a></li>
												<li><a href="view/menu/treatment/oily-s.html">Oily Scalp Only</a></li>
												<li><a href="view/menu/treatment/p-fiber.html">Profiber Treatment</a></li>
												<li><a href="view/menu/treatment/inforcer.html">Inforcer Treatment</a></li>
												<li><a href="view/menu/treatment/nutrifier.html">Nutrifier Treatment</a></li>
												<li><a href="view/menu/treatment/hair-spa.html">Hair Spa</a></li>
												<li><a href="view/menu/treatment/hairspa-scrb.html">Hair Spa Scrub</a></li>
												<li><a href="view/menu/treatment/anti-d.html">Anti Dandruff</a></li>
												<li><a href="view/menu/treatment/repair-r.html">Repair Lipidium Expert</a></li>
												<li><a href="view/menu/treatment/anti-h-lost.html">Anti Hair Lost</a></li>
											</ul>
										<li class="has-children">
											<a href="#">Massage</a>
											<ul class="dropdown">
												<li><a href="#">Massage 60'</a></li>
												<li><a href="#">Massage 90'</a></li>
												<li><a href="#">Body Massage + Scrub</a></li>
												<li><a href="#">Extra Massage 30'</a></li>
												<li><a href="#">Kid Massage</a></li>
											</ul>
							...
							<li class="has-children">
								<a href="#">Paket</a>
								<ul class="dropdown">
									<li><a href="<?php echo base_url() . "index.php/home/paket1"; ?>">Paket Satu</a></li>
									<li><a href="<?php echo base_url() . "index.php/home/paket2"; ?>">Paket Dua</a></li>
									<li><a href="view/paket/paket-3.html">Paket Tiga</a></li>
									<li><a href="view/paket/paket-4.html">Paket Empat</a></li>
									<li><a href="view/paket/paket-5.html">Paket Lima</a></li>
									<li><a href="view/paket/paket-6.html">Paket Enam</a></li>
									<li><a href="view/paket/paket-7.html">Paket Tujuh</a></li>
								</ul>
							</li>
							<!--<li><a href="services.html">Layanan</a></li>-->
							<li><a href="<?php echo base_url() . "index.php/home/pesanan"; ?>">Pesanan</a></li>
							<li><a href="<?php echo base_url() . "index.php/home/kontak"; ?>">Kontak</a></li>
					...
					<div class="col-6 col-xl-2 text-right" data-aos="fade-down">
						<div class="d-none d-xl-inline-block">
							<ul class="site-menu js-clone-nav ml-auto list-unstyled d-flex text-right mb-0" data-class="social">
								...
								<li>
									<a href="#" class="pl-3 pr-3 text-black"><span class="icon-whatsapp"></span></a>
								</li>
								<li>
		...
		<header class="header-2">
			<div class="page-header min-vh-75" style="background-image: url('<?php echo base_url() . "assets/"; ?>images/hero_bg_2.jpg')">
				<div class="container">
					<div class="row">
						<div class="col-lg-7 text-center mx-auto">
							<h1 class="text-white pt-3 mt-n5">Paket 1</h1>
							<p class="lead text-white mt-3"> Pilih paket hemat terbaik Anda<br /> Dan manjakan diri Anda untuk cantik luara biasa </p>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-4 position-relative">
								<div class="p-3 text-center">
									<h1 class="text-gradient text-primary"><span id="state1" countTo="700">0</span>+</h1>
									<h5 class="mt-3">Member</h5>
									<p class="text-sm">Sudah banyak orang membuktikan layanan terbaik kami</p>
								</div>
							...
							<div class="col-md-4 position-relative">
								<div class="p-3 text-center">
									...
									<h5 class="mt-3">Karyawan terbaik</h5>
									<p class="text-sm">Kami memiliki karyawan dengan bekal pengalaman yang mumpuni</p>
								</div>
								<hr class="vertical dark">
							</div>
							<div class="col-md-4">
								<div class="p-3 text-center">
									...
									<h5 class="mt-3">Cabang</h5>
									<p class="text-sm">Kami memiliki cabang di Jabodetabek</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row justify-content-left">
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Gunting</h5>
									<p class="pe-5"> Penata rambut memiliki lebih banyak pengalaman memotong dan menata rambut. </p>
									<hr>
								</div>
							</div>
							<div class="col-md-6">
								<div class="info">
									...
									<h5 class="font-weight-bolder mt-3">Blow (catok/ variasi/ haido)</h5>
									<p class="pe-3">Rambut blow dapat menciptakan efek lebih tebal, bervolume, indah, dan rapi pada rambut.</p>
									<hr>
								</div>
							</div>
						</div>
                          ...
                          <g transform="translate(1716.000000, 291.000000)">
                            <g id="time-alarm" transform="translate(603.000000, 149.000000)">
                              ...
                              <path class="color-background" d="M34.3815652,34.7668696 C40.2057958,27.7073059 39.5440671,17.3375603 32.869743,11.0755718 C26.1954189,4.81358341 15.8045811,4.81358341 9.13025701,11.0755718 C2.45593289,17.3375603 1.79420418,27.7073059 7.61843478,34.7668696 L3.9753913,40.0506522 C3.58549114,40.5871271 3.51710058,41.2928217 3.79673036,41.8941824 C4.07636014,42.4955431 4.66004722,42.8980248 5.32153275,42.9456105 C5.98301828,42.9931963 6.61830436,42.6784048 6.98113043,42.1232609 L10.2744783,37.3434783 C16.5555112,42.3298213 25.4444888,42.3298213 31.7255217,37.3434783 L35.0188696,42.1196087 C35.6014207,42.9211577 36.7169135,43.1118605 37.53266,42.5493622 C38.3484064,41.9868639 38.5667083,40.8764423 38.0246087,40.047 L34.3815652,34.7668696 Z M30.1304348,25.5652174 L21,25.5652174 C20.49574,25.5652174 20.0869565,25.1564339 20.0869565,24.6521739 L20.0869565,15.5217391 C20.0869565,15.0174791 20.49574,14.6086957 21,14.6086957 C21.50426,14.6086957 21.9130435,15.0174791 21.9130435,15.5217391 L21.9130435,23.7391304 L30.1304348,23.7391304 C30.6346948,23.7391304 31.0434783,24.1479139 31.0434783,24.6521739 C31.0434783,25.1564339 30.6346948,25.5652174 30.1304348,25.5652174 Z"></path>
									...
									<!--<h5 class="font-weight-bolder mt-3">Hemat Waktu & Biaya</h5>
                  <p class="pe-5">Dengan adanya sistem boking yang mudah maka itu bisa menghemat waktu anda untuk tidak mengantri</p> -->
								</div>
							</div>
							<div class="col-md-6 mt-3">
								<div class="info">
                          ...
                          <g transform="translate(1716.000000, 291.000000)">
                            <g id="office" transform="translate(153.000000, 2.000000)">
                              ...
                              <path class="color-background" d="M40.25,14 L24.5,14 C23.53225,14 22.75,14.78225 22.75,15.75 L22.75,38.5 L19.25,38.5 L19.25,22.75 C19.25,21.78225 18.46775,21 17.5,21 L1.75,21 C0.78225,21 0,21.78225 0,22.75 L0,40.25 C0,41.21775 0.78225,42 1.75,42 L40.25,42 C41.21775,42 42,41.21775 42,40.25 L42,15.75 C42,14.78225 41.21775,14 40.25,14 Z M12.25,36.75 L7,36.75 L7,33.25 L12.25,33.25 L12.25,36.75 Z M12.25,29.75 L7,29.75 L7,26.25 L12.25,26.25 L12.25,29.75 Z M35,36.75 L29.75,36.75 L29.75,33.25 L35,33.25 L35,36.75 Z M35,29.75 L29.75,29.75 L29.75,26.25 L35,26.25 L35,29.75 Z M35,22.75 L29.75,22.75 L29.75,19.25 L35,19.25 L35,22.75 Z"></path>
									...
									<!-- <h5 class="font-weight-bolder mt-3">Layanan yang baik</h5>
                  <p class="pe-3">Kami mengutamakan layanan terbaik untuk pelanggan, karnanya pegwai kami juga di bekali dengan pengalaman yang baik.</p> -->
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
						<div class="card card-background card-background-mask-primary tilt" data-tilt>
							<div class="full-background" style="background-image: url('<?php echo base_url() . "assets/"; ?>images/spa-1.jpg')"></div>
							<div class="card-body pt-7 text-center">
								<div class="icon icon-lg up mb-3 mt-3">
									<svg width="50px" height="50px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
										...
										<g stroke="none" stro ke-width="1" fill="none" fill-rule="evenodd">
								...
								<h2 class="text-white up mb-0"> Datang <br /> & rasakan sendiri layanan terbaik kami </h2>
								<p><strong class="text-white up mb-0">Rp.275,000</strong></p>
								<a href=".//sections/elements/buttons.html" target="_blank" class="btn btn-outline-white mt-5 up btn-round">Booking</a>
							</div>
						</div>
					</div>
				</div>
		...
		<footer class="site-footer">
			<div class="container">
				<div class="row">
					<div class="col-lg-4">
						<div class="mb-5">
							<h3 class="footer-heading mb-4">Tentang Salon Que</h3>
							<p>Salon Que menawarkan pelayanan kecantikan dan rias pengantin secara online, dimana yang perlu anda butuhkan hanya menghubungi kami dan kami akan datang ke rumah anda</p>
						</div>
						...
						<div class="row mb-5">
							...
							<div class="col-md-6 col-lg-6">
								<ul class="list-unstyled">
									...
									<li><a href="booking.html">Pesanan</a></li>
					...
					<div class="col-lg-4 mb-5 mb-lg-0">
						<div class="mb-5">
							...
							<p>Dapatkan berita ter-update tentang penwaran menarik dari kami</p>
				...
				<div class="row pt-5 mt-5 text-center">
					<div class="col-md-12">
						...
						<p>
							...
							</script> <i class="icon-heart-o" aria-hidden="true"></i> Developed By : <a href="#" target="_blank">Hafidz</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
					</div>
	...
	<script src="<?php echo base_url() . "assets/"; ?>js/soft-design-system.min.js?v=1.0.5" type="text/javascript"></script>
